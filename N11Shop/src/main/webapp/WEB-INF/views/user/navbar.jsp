		...
		<div
			...
			<div class="col-lg-4">
				<a href="/index" class="text-decoration-none"> <span
					class="h1 text-uppercase text-primary bg-dark px-2">N11</span> <span
			...
			<div class="col-lg-9">
				<nav
					...
					<a href="" class="text-decoration-none d-block d-lg-none"> <span
						class="h1 text-uppercase text-dark bg-light px-2">N11</span> <span
